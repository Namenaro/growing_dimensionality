...
# поищем хороших кандидатов на базовые ядра
# в цикле будем кучу раз вырезать произвольный кусок ЭКГ и
# для каждого такого куска будем подсчитывать количество мест в датасете, свертываясь с которыми это ядро дает одно и то же значение


#если таких не найдется или они будут не показательны, то распиылим нейронный газ -
# в результате получим набор приблихительных ядер.
